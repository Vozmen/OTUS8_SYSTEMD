...
wget https://raw.githubusercontent.com/Vozmen/OTUS8_SYSTEMD/main/first.conf -O /etc/httpd/conf/first.conf
wget https://raw.githubusercontent.com/Vozmen/OTUS8_SYSTEMD/main/second.conf -O /etc/httpd/conf/second.conf
